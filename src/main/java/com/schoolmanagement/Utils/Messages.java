...
public class Messages {
    ...
    public static final String ALREADY_REGISTER_MESSAGE_SSN = "Error : User with username %s already ssn";
    public static final String ALREADY_REGISTER_MESSAGE_PHONE_NUMBER = "Error : User with username %s already phone number";
