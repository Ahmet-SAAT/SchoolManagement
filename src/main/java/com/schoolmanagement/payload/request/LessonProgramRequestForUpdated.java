...
public class LessonProgramRequestForUpdated {
    ...
    @NotNull(message="Please select studentlesson")
    @Size(min=1, message ="Student must not be empty")
    private List<Long> studentIdList;

    @NotNull(message="Please select teacher")
    @Size(min=1, message ="Teacher must not be empty")
