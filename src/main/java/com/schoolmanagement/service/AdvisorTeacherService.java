...
public class AdvisorTeacherService {
    ...
    public ResponseMessage<?> deleteAdvisorTeacher(Long id) {
        ...
        advisorTeacherRepository.delete(advisorTeacher);
                return ResponseMessage.builder()
                        .message("Advisor Teacher is deleted successfully")
    ...
    //NOT:SavedAdvisorTeacher()
    public void saveAdvisorTeacher(Teacher teacher) {
    AdvisorTeacher advisorTeacherBuilder=
            AdvisorTeacher.builder()
            .teacher(teacher)
