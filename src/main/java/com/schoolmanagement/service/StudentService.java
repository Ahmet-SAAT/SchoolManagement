...
public class StudentService {
    ...
    public ResponseMessage<StudentResponse> save(StudentRequest studentRequest) {
        ...
        //advisorteachersetleme
        student.setAdvisorTeacher(advisorTeacher);
        //userroleservicesetleme
        ...
        return ResponseMessage.<StudentResponse>builder()
                .object(createStudentResponse(studentRepository.save(student)))//save isini de burada yaptim
    ...
    // Not: getStudentById() ******************************************************
    public Student getStudentByIdForResponse(Long id) {//service katinda pojo goruyorsak muhtemelen o baska service ile cagrilacaktir.
